...
def check_environment_variables():
    ...
    show_key_values_16_chars(REQUIRED_VARS)         # 5) Optionally, show the first 16 characters of each required environment variable for verification (avoid printing the entire key for security reasons).
