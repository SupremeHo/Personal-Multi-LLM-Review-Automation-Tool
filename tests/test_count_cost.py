...
def test_cost_without_cache():
    cost = calculate_token_cost(
        PRICE_TABLE, "base", input_tokens=1_000_000, output_tokens=1_000_000
    )
...
def test_cost_with_cache_discounts_cached_portion():
    cost = calculate_token_cost(
        PRICE_TABLE,
        "base",
    ...
    # 800k normal @1.0 + 200k cached @0.5 = 0.8 + 0.1
